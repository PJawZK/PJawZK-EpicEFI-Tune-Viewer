...
export default function LocalTuneViewer() {
  ...
  return (
    <main>
      ...
      <footer>
        Local viewer — INI-driven tune navigation with exact-signature definitions and manual fallback. Local MSQ/INI files
        are not published.
      </footer>
    </main>
  );
